                ...
                $.map(result, function (item, i) {
                    $("#myTable").append(
                        '<tr class="tablerow"><td><button onclick="cetak(' +
                            ...
                            item.tujuan +
                            "</td>" +
                            '<td><input type="number" class="col-xs-2" id="admin" placeholder="Admin"></td>' +
                            "<td>" +
                            item.harga +
                            "</td>" +
                            "<td>" +
